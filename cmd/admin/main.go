...
func main() {
	...
	// GET    /admin/v1/projects/:id/provider-access        — list grants
	// POST   /admin/v1/projects/:id/provider-access        — create/update grant
	// PUT    /admin/v1/projects/:id/provider-access/:provider_id — update prefix rules
	// DELETE /admin/v1/projects/:id/provider-access/:provider_id — revoke grant
	a.GET("/projects/:id/provider-access", catalogH.ListProjectProviderAccess)
	a.POST("/projects/:id/provider-access", catalogH.GrantProjectProviderAccess)
